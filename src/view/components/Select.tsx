...
export function Select({ className, placeholder, options, error, onChange, value, disabled }: SelectProps) {
    ...
    <div>
      <div className="relative">
        ...
        <RdxSelect.Root value={value} onValueChange={handleSelect} disabled={disabled}>
          <RdxSelect.Trigger
            className={cn(
              'bg-white w-full rounded-lg border border-gray-500 px-3 h-[52px] text-gray-800 focus:border-gray-800 transition-all outline-none text-left relative pt-4 disabled:bg-gray-100 disabled:text-gray-600 disabled:cursor-not-allowed',
